...
ffm_float ffm_predict(ffm_node *begin, ffm_node *end, ffm_model *model, const char isprint = false)
{
    ffm_float r = 1;
    ...
    for(ffm_node *N1 = begin; N1 != end; N1++)
    {
	    ...
	    ffm_float tt = 0;
	      ...
	      { tt += w1[d]*w2[d]*v; }
	    if (isprint) cout << fixed << setprecision(5) << tt << " ";
	    t += tt;
        }
    }
    cout << endl;
